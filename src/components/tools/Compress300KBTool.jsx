...
const Compress300KBTool = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${config.API_BASE_URL}/api/tools/compress-300kb`, {
        method: 'POST',
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-8">
      <div className="max-w-6xl mx-auto px-4">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">Compress to 300 KB</h1>
          <p className="text-gray-600 dark:text-gray-400 text-lg">Compress your image to under 300 KB automatically</p>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-green-50 dark:bg-green-900/30 p-4 rounded-lg">
                  ...
                  <div className="text-sm text-green-700 dark:text-green-300 space-y-1">
                    ...
                    <p><span className="font-medium">Target:</span> 300 KB</p>
                  </div>
                </div>
                <button
                  onClick={() => { const a = document.createElement('a'); a.href = result.url; a.download = `compress-300kb_${Date.now()}.jpg`; a.click(); }}
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-center text-base px-8">
                      Upload an image to compress it to under 300 KB
                    </p>
                  </>
                )}
              </div>
...
export default Compress300KBTool;
