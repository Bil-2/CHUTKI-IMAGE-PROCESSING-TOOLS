...
const KBtoMBTool = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${config.API_BASE_URL}/api/tools/kb-to-mb`, {
        method: 'POST',
  ...
  const handleDownload = () => {
    if (result) {
      ...
      a.href = result;
      a.download = 'kb-to-mb-' + Date.now() + '.jpg';
      a.click();
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">KB to MB</h1>
