...
const WatermarkTool = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${config.API_BASE_URL}/api/tools/watermark`, {
        method: 'POST',
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">Advanced Watermark</h1>
          <p className="text-gray-600 dark:text-gray-400 text-lg">Add professional watermarks with customizable styles</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6 flex items-center">
              ...
              Upload Image & Customize Watermark
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                  <span>12px</span>
                  <span className="font-medium">{formData.fontSize}px</span>
                  <span>120px</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                  <span>0%</span>
                  <span className="font-medium">{Math.round(formData.opacity * 100)}%</span>
                  <span>100%</span>
                </div>
              </div>
